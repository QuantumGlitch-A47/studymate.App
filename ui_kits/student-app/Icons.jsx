/* StudyMate Icons — inline Lucide paths (1.75px outline).
   Renders SVG inner markup via dangerouslySetInnerHTML to avoid
   React/Lucide DOM-swap conflicts. */
const SM_ICON_PATHS = {
  "building-2":
  ...
  armchair:
    '<path d="M19 9V6a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v3"/><path d="M3 16a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1z"/><path d="M5 18v2M19 18v2"/>',
  calendar:
  ...
  coffee:
    '<path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4Z"/><line x1="6" x2="6" y1="2" y2="4"/><line x1="10" x2="10" y1="2" y2="4"/><line x1="14" x2="14" y1="2" y2="4"/>',
...
function Icon({ name, size = 20, strokeWidth = 1.75, className = "", style = {} }) {
  const inner = SM_ICON_PATHS[name] || "";
  return (
    <svg
      width={size}
      height={size}
